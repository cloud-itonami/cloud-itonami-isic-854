# Operator Quickstart — enrollee-unverified

Shortest path from clone to a verified local dry-run for **ISIC 854** (`cloud-itonami-isic-854`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-854.git
cd cloud-itonami-isic-854
```
